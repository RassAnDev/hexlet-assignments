...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("USA", null, "Paradise", "1", "15");
        ...
        Address address2 = new Address("Russia", "N/A", "Hellfire", "1", null);
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = new HashMap<>();
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address(null, "Moscow", "FooBar", "15", null);
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("country", List.of("can not be null"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
