...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        updatedPerson.setFirstName("King");
        updatedPerson.setLastName("Night");
        updatedPerson.setEmail("kingofnight@dark.com");
        ...
        assertNotNull(repository.findById(existingPersonId));
        assertThat(repository.findById(existingPersonId).getEmail()).isEqualTo("kingofnight@dark.com");
    }
    ...
    public void testDeletePerson() throws Exception {
        ...
        mockMvc.perform(
                delete("/people/{id}", existingPersonId)
        )
                .andExpect(status().isOk());

        assertNull(repository.findById(existingPersonId));
    }
    // END
}
